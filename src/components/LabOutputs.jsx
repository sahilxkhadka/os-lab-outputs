                                ...
                                <>
                                    <div key={lab.id} className={`slide-container`}>
                                        <div className="output-container">
                                            <h2>{lab.labName}</h2>
                                            <p align="center" style={{ color: '#fff' }}>(You can also edit the path name manually)</p>
                                            <div className="output-terminal" id={lab.id}>
                                                <blockquote className="output-path" spellCheck="false" contentEditable={true} key={lab.labName}>
